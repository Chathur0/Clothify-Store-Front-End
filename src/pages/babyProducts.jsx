...
import banner from "/banner_images/baby.jpg";
  ...
  return (
    <>
      ...
      <div className="container mt-5">
        <h2 className="text-center">Baby’s Clothing & Accessories</h2>
        <p className="text-center">
          Wrap your little bundle of joy in the softest fabrics and adorable
          designs. Our baby collection features everything from cozy onesies to
          festive outfits, all made with love and care. Don't forget to check
          out our accessories, including bibs, blankets, and booties, designed
          to keep your baby happy and comfy.
        </p>
        <div className="row">
          {loading ? (
