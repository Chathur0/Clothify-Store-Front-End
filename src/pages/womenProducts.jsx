  ...
  return (
    <>
      ...
      <div className="container mt-5">
        <h2 className="text-center">Women’s Clothing & Accessories</h2>
        <p className="text-center">
          Celebrate your style with our exquisite collection of women's wear.
          Explore elegant dresses, trendy tops, and versatile ethnic wear
          tailored to suit every taste. Complement your outfits with our
          exclusive accessories, including handbags, jewelry, and scarves. Our
          range combines sophistication and comfort to empower you every day.
        </p>
        <div className="row">
          {loading ? (
