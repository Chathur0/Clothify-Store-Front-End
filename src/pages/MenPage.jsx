...
import banner from "/banner_images/men.jpg";
...
const MenProducts = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await fetch("http://localhost:8080/get-men-product");
  ...
  return (
    <>
      ...
      <div className="container mt-5">
        <h2 className="text-center">Men’s Clothing & Accessories</h2>
        <p className="text-center">
          Discover a collection crafted for the modern man. From sleek formal
          wear to comfortable casuals, we offer timeless pieces designed for
          every occasion. Pair your outfit with our premium accessories,
          including stylish watches, belts, and wallets, to complete your look.
          Whether you're dressing for work, a party, or a weekend outing, we've
          got you covered
        </p>
        <div className="row">
          {loading ? (
